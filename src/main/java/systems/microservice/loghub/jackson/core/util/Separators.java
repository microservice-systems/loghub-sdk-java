...
/**
 * Value class used with some {@link systems.microservice.loghub.jackson.core.PrettyPrinter}
 * implements
 *
 * @see systems.microservice.loghub.jackson.core.util.DefaultPrettyPrinter
 * @see systems.microservice.loghub.jackson.core.util.MinimalPrettyPrinter
 * 
 * @since 2.9
 */
