package systems.microservice.loghub.format.jackson.core.sym;

import java.util.Arrays;
import java.util.BitSet;
import java.util.concurrent.atomic.AtomicReference;

import systems.microservice.loghub.format.jackson.core.JsonFactory;
import systems.microservice.loghub.format.jackson.core.util.InternCache;
...
public final class CharsToNameCanonicalizer
{
     ...
     * intent has been 38 (with "systems.microservice.loghub.format.jackson.core.main.TestWithTonsaSymbols");
    ...
    /**
     * Method called to create root canonicalizer for a {@link systems.microservice.loghub.format.jackson.core.JsonFactory}
     ...
     *
     * @param flags Bit flags of active {@link systems.microservice.loghub.format.jackson.core.JsonFactory.Feature}s enabled.
     *
