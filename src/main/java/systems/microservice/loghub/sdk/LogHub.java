...
public final class LogHub {
    ...
    private static int createEventFlushSize(Map<String, String> properties) {
        ...
        return Validator.inRangeInt("loghub.event.flush.size", Integer.parseInt(efs), 0, Integer.MAX_VALUE);
    }
    ...
    private static long createEventFlushSpan(Map<String, String> properties) {
        ...
        return Validator.inRangeLong("loghub.event.flush.span", Long.parseLong(efs), 3000L, 86400000L);
    }
    ...
    private static long createEventPersistenceSize(Map<String, String> properties) {
        ...
        return Validator.inRangeLong("loghub.event.persistence.size", Long.parseLong(eps), 0L, Long.MAX_VALUE);
    }
    ...
    private static int createEventFlushRetryCount(Map<String, String> properties) {
        ...
        return Validator.inRangeInt("loghub.event.flush.retry.count", Integer.parseInt(efrc), 1, Integer.MAX_VALUE);
    }
    ...
    private static long createEventFlushRetryDelay(Map<String, String> properties) {
        ...
        return Validator.inRangeLong("loghub.event.flush.retry.delay", Long.parseLong(efrd), 0L, 86400000L);
    }
