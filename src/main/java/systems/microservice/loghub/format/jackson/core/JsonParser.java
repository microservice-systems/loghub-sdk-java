...
package systems.microservice.loghub.format.jackson.core;
...
import systems.microservice.loghub.format.jackson.core.async.NonBlockingInputFeeder;
import systems.microservice.loghub.format.jackson.core.exc.InputCoercionException;
import systems.microservice.loghub.format.jackson.core.type.TypeReference;
import systems.microservice.loghub.format.jackson.core.util.JacksonFeatureSet;
import systems.microservice.loghub.format.jackson.core.util.RequestPayload;
    ...
    implements Closeable, Versioned
{
    ...
    public enum Feature {
         ...
         * {@link systems.microservice.loghub.format.jackson.core.json.JsonReadFeature#ALLOW_JAVA_COMMENTS} instead.
         */
         ...
         *<p>
         * NOTE: while not technically deprecated, since 2.10 recommended to use
         * {@link systems.microservice.loghub.format.jackson.core.json.JsonReadFeature#ALLOW_YAML_COMMENTS} instead.
         */
         ...
         *<p>
         * NOTE: while not technically deprecated, since 2.10 recommended to use
         * {@link systems.microservice.loghub.format.jackson.core.json.JsonReadFeature#ALLOW_UNQUOTED_FIELD_NAMES} instead.
         */
         ...
         *<p>
         * NOTE: while not technically deprecated, since 2.10 recommended to use
         * {@link systems.microservice.loghub.format.jackson.core.json.JsonReadFeature#ALLOW_SINGLE_QUOTES} instead.
         */
         ...
         * this is a non-standard feature, and as such disabled by default.
         *
         * @deprecated Since 2.10 use {@link systems.microservice.loghub.format.jackson.core.json.JsonReadFeature#ALLOW_UNESCAPED_CONTROL_CHARS} instead
         */
        @Deprecated
         ...
         * this is a non-standard feature, and as such disabled by default.
         *
         * @deprecated Since 2.10 use {@link systems.microservice.loghub.format.jackson.core.json.JsonReadFeature#ALLOW_BACKSLASH_ESCAPING_ANY_CHARACTER} instead
         */
        @Deprecated
         ...
         * this is a non-standard feature, and as such disabled by default.
         *
         * @deprecated Since 2.10 use {@link systems.microservice.loghub.format.jackson.core.json.JsonReadFeature#ALLOW_LEADING_ZEROS_FOR_NUMBERS} instead
         */
         @Deprecated
        ALLOW_NUMERIC_LEADING_ZEROS(false),

        /**
         * @deprecated Use {@link systems.microservice.loghub.format.jackson.core.json.JsonReadFeature#ALLOW_LEADING_DECIMAL_POINT_FOR_NUMBERS} instead
         */
        @Deprecated
         ...
         * this is a non-standard feature, and as such disabled by default.
          *
          * @deprecated Since 2.10 use {@link systems.microservice.loghub.format.jackson.core.json.JsonReadFeature#ALLOW_NON_NUMERIC_NUMBERS} instead
          */
         @Deprecated
          ...
          * @since 2.8
          *
          * @deprecated Since 2.10 use {@link systems.microservice.loghub.format.jackson.core.json.JsonReadFeature#ALLOW_MISSING_VALUES} instead
          */
         @Deprecated
          ...
          * @since 2.9
          *
          * @deprecated Since 2.10 use {@link systems.microservice.loghub.format.jackson.core.json.JsonReadFeature#ALLOW_TRAILING_COMMA} instead
          */
         @Deprecated
     ...
     * {@link systems.microservice.loghub.format.jackson.core.JsonParser.Feature}s
     * are enabled.
     */
     ...
     * {@link systems.microservice.loghub.format.jackson.core.JsonFactory} for details,
     * but the general
