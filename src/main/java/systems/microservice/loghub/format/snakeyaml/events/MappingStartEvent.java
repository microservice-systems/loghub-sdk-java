...
public final class MappingStartEvent extends CollectionStartEvent {
     ...
     * @deprecated Since restored in v1.22.  Use {@link MappingStartEvent#CollectionStartEvent(String, String, boolean, Mark, Mark, systems.microservice.loghub.format.snakeyaml.DumperOptions.FlowStyle) }.
     */
    @Deprecated
    public MappingStartEvent(String anchor, String tag, boolean implicit, Mark startMark,
