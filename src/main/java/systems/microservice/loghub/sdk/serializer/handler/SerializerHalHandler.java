 ...
 * @since 1.0
 */
public class SerializerHalHandler implements SerializerHandler, Serializable {
    private static final long serialVersionUID = 1L;

    protected final ObjectMapper mapper = new HALMapper().disable(JsonParser.Feature.AUTO_CLOSE_SOURCE).disable(JsonGenerator.Feature.AUTO_CLOSE_TARGET);

    public SerializerHalHandler() {
    }
