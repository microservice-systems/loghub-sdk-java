...
public class SerializerCborHandler implements SerializerHandler, Serializable {
    ...
    public <T> T read(byte[] array, Class<T> clazz) {
        try {
            ...
            throw new SerializerException(Serializer.CBOR, SerializerOperation.READ, clazz, e);
        }
    }
    ...
    public <T> T read(String string, Class<T> clazz) {
        throw new UnsupportedOperationException(String.format("[%s][%s]: Text format is not supported", Serializer.CBOR, SerializerOperation.READ));
    }
    ...
    public <T> byte[] write(T object) {
        try {
            ...
            throw new SerializerException(Serializer.CBOR, SerializerOperation.WRITE, object.getClass(), e);
        }
    }
    ...
    public <T> String writeS(T object) {
        throw new UnsupportedOperationException(String.format("[%s][%s]: Text format is not supported", Serializer.CBOR, SerializerOperation.WRITE));
    }
