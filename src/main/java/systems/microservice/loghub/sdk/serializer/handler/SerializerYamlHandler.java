 ...
 * @since 1.0
 */
public class SerializerYamlHandler implements SerializerHandler, Serializable {
    private static final long serialVersionUID = 1L;

    protected final YAMLFactory factory = new YAMLFactory();
    ...
    public <T> T read(byte[] array, Class<T> clazz) {
        try {
            ...
            throw new SerializerException(Serializer.YAML, SerializerOperation.READ, clazz, e);
        }
    }
    ...
    public <T> byte[] write(T object) {
        try {
            ...
            throw new SerializerException(Serializer.YAML, SerializerOperation.WRITE, object.getClass(), e);
        }
    }
