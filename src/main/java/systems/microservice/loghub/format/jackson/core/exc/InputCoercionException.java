package systems.microservice.loghub.format.jackson.core.exc;
 ...
 * problems (those would be reported as {@link systems.microservice.loghub.format.jackson.core.JsonParseException}s),
