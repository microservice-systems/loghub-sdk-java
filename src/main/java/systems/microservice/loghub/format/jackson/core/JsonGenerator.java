...
import systems.microservice.loghub.format.jackson.core.JsonParser.NumberType;
import systems.microservice.loghub.format.jackson.core.io.CharacterEscapes;
import systems.microservice.loghub.format.jackson.core.type.WritableTypeId;
import systems.microservice.loghub.format.jackson.core.type.WritableTypeId.Inclusion;
...
import static systems.microservice.loghub.format.jackson.core.JsonTokenId.*;
    ...
    implements Closeable, Flushable, Versioned
{
    ...
    public enum Feature {
         ...
         *
         * @deprecated Since 2.10 use {@link systems.microservice.loghub.format.jackson.core.json.JsonWriteFeature#QUOTE_FIELD_NAMES} instead
         */
        @Deprecated
         ...
         * Feature is enabled by default.
         *
         * @deprecated Since 2.10 use {@link systems.microservice.loghub.format.jackson.core.json.JsonWriteFeature#WRITE_NAN_AS_STRINGS} instead
         */
         @Deprecated
         ...
         *
         * @deprecated Since 2.10 use {@link systems.microservice.loghub.format.jackson.core.json.JsonWriteFeature#ESCAPE_NON_ASCII} instead
         */
        @Deprecated
         ...
         * Feature is disabled by default.
         *
         * @deprecated Since 2.10 use {@link systems.microservice.loghub.format.jackson.core.json.JsonWriteFeature#WRITE_NUMBERS_AS_STRINGS} instead
         */
        @Deprecated
...
//        throw new IllegalArgumentException("No FormatFeatures defined for generator of type "+getClass().getName());
     ...
     * ({@link systems.microservice.loghub.format.jackson.core.util.DefaultPrettyPrinter}).
     *
     * @return This generator, to allow call chaining
     */
