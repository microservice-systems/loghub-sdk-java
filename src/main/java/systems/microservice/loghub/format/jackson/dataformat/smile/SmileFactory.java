...
import systems.microservice.loghub.format.jackson.dataformat.smile.async.NonBlockingByteArrayParser;
...
public class SmileFactory extends JsonFactory
{
     ...
     *
     * @param src - smile factory
     * @param oc - object codec
     *
     * @since 2.2.1
     */
