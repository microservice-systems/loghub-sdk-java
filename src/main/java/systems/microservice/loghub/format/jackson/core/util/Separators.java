package systems.microservice.loghub.format.jackson.core.util;

import java.io.Serializable;

/**
 * Value class used with some {@link systems.microservice.loghub.format.jackson.core.PrettyPrinter}
 * implements
 *
 * @see systems.microservice.loghub.format.jackson.core.util.DefaultPrettyPrinter
 * @see systems.microservice.loghub.format.jackson.core.util.MinimalPrettyPrinter
 * 
 * @since 2.9
 */
