 ...
 *<p>
 * With 2.9, an additional type ({@link systems.microservice.loghub.format.jackson.core.type.WritableTypeId})
 * was added to help handling of type identifiers needed to support polymorphic
 * type serialization, deserialization.
 */
package systems.microservice.loghub.format.jackson.core.type;
