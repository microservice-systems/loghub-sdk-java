...
public class SerializerPropsHandler implements SerializerHandler, Serializable {
    ...
    protected final JavaPropsFactory factory = new JavaPropsFactory();
    ...
    public <T> T read(byte[] array, Class<T> clazz) {
        try {
            ...
            throw new SerializerException(Serializer.PROPS, SerializerOperation.READ, clazz, e);
        }
    }
    ...
    public <T> byte[] write(T object) {
        try {
            ...
            throw new SerializerException(Serializer.PROPS, SerializerOperation.WRITE, object.getClass(), e);
        }
    }
