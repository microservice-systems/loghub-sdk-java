...
import systems.microservice.loghub.format.jackson.core.base.GeneratorBase;
import systems.microservice.loghub.format.jackson.core.json.JsonWriteContext;
import systems.microservice.loghub.format.jackson.core.util.JacksonFeatureSet;
import systems.microservice.loghub.format.jackson.dataformat.yaml.util.StringQuotingChecker;
...
public class YAMLGenerator extends GeneratorBase
{
    ...
    protected final systems.microservice.loghub.format.snakeyaml.DumperOptions.Version _docVersion;
    ...
    public YAMLGenerator(IOContext ctxt, int jsonFeatures, int yamlFeatures,
            ...
            systems.microservice.loghub.format.snakeyaml.DumperOptions.Version version)
        throws IOException
    {
    ...
    public YAMLGenerator(IOContext ctxt, int jsonFeatures, int yamlFeatures,
            ObjectCodec codec, Writer out,
            systems.microservice.loghub.format.snakeyaml.DumperOptions.Version version) throws IOException {
