...
import systems.microservice.loghub.format.snakeyaml.events.*;
...
import systems.microservice.loghub.format.jackson.core.*;
import systems.microservice.loghub.format.jackson.core.base.ParserBase;
import systems.microservice.loghub.format.jackson.core.io.IOContext;
...
//    @Override public CsvSchema getSchema() 
    ...
    public JsonToken nextToken() throws IOException
    {
        ...
        while (true) {
            ...
            } catch (systems.microservice.loghub.format.snakeyaml.error.YAMLException e) {
                if (e instanceof systems.microservice.loghub.format.snakeyaml.error.MarkedYAMLException) {
                    throw systems.microservice.loghub.format.jackson.dataformat.yaml.snakeyaml.error.MarkedYAMLException.from
                        (this, (systems.microservice.loghub.format.snakeyaml.error.MarkedYAMLException) e);
                }
