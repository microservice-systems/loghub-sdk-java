...
import systems.microservice.loghub.format.jackson.core.io.InputDecorator;
import systems.microservice.loghub.format.jackson.core.io.OutputDecorator;
import systems.microservice.loghub.format.jackson.core.json.JsonReadFeature;
import systems.microservice.loghub.format.jackson.core.json.JsonWriteFeature;
    ...
    B extends TSFBuilder<F,B>>
{
    ...
    /**
     * Set of {@link systems.microservice.loghub.format.jackson.core.JsonFactory.Feature}s enabled,
     * as bitmask.
     */
