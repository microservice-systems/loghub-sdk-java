...
import systems.microservice.loghub.format.jackson.core.format.InputAccessor;
import systems.microservice.loghub.format.jackson.core.format.MatchStrength;
import systems.microservice.loghub.format.jackson.core.io.*;
import systems.microservice.loghub.format.jackson.core.json.*;
import systems.microservice.loghub.format.jackson.core.json.async.NonBlockingJsonParser;
import systems.microservice.loghub.format.jackson.core.sym.ByteQuadsCanonicalizer;
import systems.microservice.loghub.format.jackson.core.sym.CharsToNameCanonicalizer;
import systems.microservice.loghub.format.jackson.core.util.BufferRecycler;
import systems.microservice.loghub.format.jackson.core.util.BufferRecyclers;
import systems.microservice.loghub.format.jackson.core.util.DefaultPrettyPrinter;
import systems.microservice.loghub.format.jackson.core.util.JacksonFeature;
        ...
        java.io.Serializable // since 2.1 (for Android, mostly)
{
     ...
     * {@link systems.microservice.loghub.format.jackson.core.async.NonBlockingInputFeeder}.
     *
     ...
     * a <code>systems.microservice.loghub.format.jackson.databind.ObjectMapper</code>)
     ...
     * if (and only if) {@link systems.microservice.loghub.format.jackson.core.StreamReadFeature#AUTO_CLOSE_SOURCE}
     * is enabled.
     *<p>
     *
     ...
     * via {@link systems.microservice.loghub.format.jackson.core.async.ByteArrayFeeder}
     ...
     * feature,
     * {@link systems.microservice.loghub.format.jackson.core.JsonGenerator.Feature#AUTO_CLOSE_TARGET}
     * is enabled).
     ...
     * {@link JsonGenerator#close} is called (unless auto-closing
     * feature,
     * {@link systems.microservice.loghub.format.jackson.core.JsonGenerator.Feature#AUTO_CLOSE_TARGET} is enabled).
     ...
     * the parser, it will still be managed (i.e. closed if
     * end-of-stream is reacher, or parser close method called)
     * if (and only if) {@link systems.microservice.loghub.format.jackson.core.JsonParser.Feature#AUTO_CLOSE_SOURCE}
     * is enabled.
     *<p>
     *
     * Note: no encoding argument is taken since it can always be
