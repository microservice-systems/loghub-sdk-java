...
public final class SequenceStartEvent extends CollectionStartEvent {
     ...
     * @deprecated Since restored in v1.22.  Use {@link SequenceStartEvent#SequenceStartEvent(String, String, boolean, Mark, Mark, systems.microservice.loghub.format.snakeyaml.DumperOptions.FlowStyle) }.
     */
    @Deprecated
    public SequenceStartEvent(String anchor, String tag, boolean implicit, Mark startMark,
