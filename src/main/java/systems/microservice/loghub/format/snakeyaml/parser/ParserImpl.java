 ...
 */
package systems.microservice.loghub.format.snakeyaml.parser;
...
import systems.microservice.loghub.format.snakeyaml.events.Event;
...
import systems.microservice.loghub.format.snakeyaml.scanner.Scanner;
import systems.microservice.loghub.format.snakeyaml.scanner.ScannerImpl;
        ...
        if (scanner.checkToken(Token.ID.Alias)) {
            ...
            if (indentlessSequence && scanner.checkToken(Token.ID.BlockEntry)) {
                ...
                if (scanner.checkToken(Token.ID.Scalar)) {
                    ...
                    Token token = scanner.peekToken();
                    throw new ParserException("while parsing a " + (block ? "block" : "flow") + " node", startMark,
