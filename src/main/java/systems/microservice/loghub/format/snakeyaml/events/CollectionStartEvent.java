 ...
 */
package systems.microservice.loghub.format.snakeyaml.events;
...
public abstract class CollectionStartEvent extends NodeEvent {
     ...
     * @deprecated Since restored in v1.22.  Use {@link CollectionStartEvent#CollectionStartEvent(String, String, boolean, Mark, Mark, systems.microservice.loghub.format.snakeyaml.DumperOptions.FlowStyle) }.
     */
    @Deprecated
    public CollectionStartEvent(String anchor, String tag, boolean implicit, Mark startMark, 
