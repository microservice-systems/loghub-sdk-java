 ...
 * @since 1.0
 */
public class SerializerJsonHandler implements SerializerHandler, Serializable {
    ...
    public <T> T read(byte[] array, Class<T> clazz) {
        try {
            ...
            throw new SerializerException(Serializer.JSON, SerializerOperation.READ, clazz, e);
        }
    }
    ...
    public <T> byte[] write(T object) {
        try {
            ...
            throw new SerializerException(Serializer.JSON, SerializerOperation.WRITE, object.getClass(), e);
        }
    }
