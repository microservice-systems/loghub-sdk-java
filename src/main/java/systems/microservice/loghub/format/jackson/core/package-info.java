 ...
 * processor: most importantly {@link systems.microservice.loghub.format.jackson.core.JsonFactory}
 * used for constructing
 * JSON parser ({@link systems.microservice.loghub.format.jackson.core.JsonParser})
 * and generator
 ...
 * <ul>
 *<li>{@link systems.microservice.loghub.format.jackson.core.TreeNode} is included
 ...
 *  </li>
 *<li>{@link systems.microservice.loghub.format.jackson.core.ObjectCodec} is included so that
 *  reference to the object capable of serializing/deserializing
 *  Objects to/from JSON (usually, <code>systems.microservice.loghub.format.jackson.databind.ObjectMapper</code>)
